...
function SQL_FormatChaine($chaine)   {
...
function SQL_FormatDateHeure($date, $heure)   {
...
function SQL_FormatNombre($nombre)   {
...
/****************************************************************************************/
/*test de Bit  : Renvoi 1 si varaible connue*/
function SQL_FormatBit($bit)   {
	if (isset($bit))
		return 1;
	else
		return 0;
...
/****************************************************************************************/
/*Permet la désactivation de script en donnée sortante*/
function SQL_HTML($chaine)   {
...
function LOG_ACTION($user, $priorite, $commentaire)   {
	$user		= SQL_FormatNombre($user);
	$priorite	= SQL_FormatNombre($priorite);
	$commentaire= SQL_FormatChaine($commentaire);
